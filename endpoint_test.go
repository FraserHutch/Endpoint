...
func testGet(user User) (bool, string, UserOperationResult) {
	...
	req, err := http.NewRequest("POST", baseURL+"get", buf)
	req.Header.Set("Content-Type", "application/json")
	client := &http.Client{}
	resp, err := client.Do(req)
	if err != nil {
...
func testUpdate(user User) (bool, string, UserOperationResult) {
	...
	buf := new(bytes.Buffer)
	json.NewEncoder(buf).Encode(user)
	req, err := http.NewRequest("POST", baseURL+"update", buf)
	req.Header.Set("Content-Type", "application/json")
	client := &http.Client{}
	resp, err := client.Do(req)
	if err != nil {
...
func testGetAll() (bool, string, UserGetAllOperationResult) {
	...
	req, err := http.NewRequest("POST", baseURL+"getAll", buf)
	req.Header.Set("Content-Type", "application/json")
	client := &http.Client{}
	resp, err := client.Do(req)
	if err != nil {
...
func TestDelete(t *testing.T) {
	...
	log.Println("TestDelete():testing remaining users - retrieinving all")
	if success, msg, userResp := testGetAll(); success == true {
